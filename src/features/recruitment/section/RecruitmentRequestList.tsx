  ...
  return (
    <div className="bg-white rounded-lg border border-ds-grey-200 overflow-hidden">
      ...
      <div className="flex items-center h-11 bg-ds-grey-50 border-b border-ds-grey-200">
        ...
        <div className="w-44 px-3 text-[13px] font-medium text-ds-grey-600 shrink-0">플랫폼</div>
        ...
        <div className="w-28 px-3 text-[13px] font-medium text-ds-grey-600 shrink-0">요청일</div>
      ...
      {mockRecruitmentRequests.map((item, i) => {
        ...
        return (
          ...
          >
            ...
            <div className="w-44 px-3 text-sm text-ds-grey-900 shrink-0">{item.platformType}</div>
            <div className="flex-1 px-3 text-[13px] text-primary truncate">
