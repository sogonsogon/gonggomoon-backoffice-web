import type { JobType, PostStatus, PostSubmissionStatus } from '@/features/recruitment/types';
...
export const ANALYSIS_STATUS_LABELS: Record<Exclude<PostStatus, 'PUBLISHED'>, string> = {
  ANALYSIS_DONE: '검토 대기',
  ANALYZING: '분석 중',
};
...
export const REQUEST_STATUS_LABELS: Record<PostSubmissionStatus, string> = {
  PENDING: '요청됨',
  APPROVED: '승인됨',
  REJECTED: '거절됨',
};

export const REQUEST_STATUS_BADGE: Record<PostSubmissionStatus, string> = {
