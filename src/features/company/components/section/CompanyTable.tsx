...
const headerRow = (
  <div className="flex items-center h-11 bg-ds-grey-50 border-b border-ds-grey-200">
    ...
    <div className="flex-1 px-4 text-[13px] font-medium text-ds-grey-600">사업 분야</div>
    <div className="flex-1 px-4 text-[13px] font-medium text-ds-grey-600">기업 유형</div>
    <div className="flex-1 px-4 text-[13px] font-medium text-ds-grey-600">임직원 수</div>
    <div className="flex-1 px-4 text-[13px] font-medium text-ds-grey-600">설립연도</div>
