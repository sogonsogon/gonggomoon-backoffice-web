    ...
    <Card className="flex-1 gap-4 border-ds-grey-200 bg-white py-4">
      ...
      <CardContent className="space-y-4 px-6">
        <div className="space-y-2">
          <p className="text-sm font-semibold text-ds-grey-900">핵심 산업 키워드</p>
          <div className="flex min-h-10 flex-wrap items-center gap-1 rounded-md border border-ds-grey-200 bg-ds-grey-50 px-2 py-1">
            {analysis.keyword.map((item) => (
              <Badge
                key={item}
                variant="outline"
                className="border-ds-grey-300 bg-white text-[12px] font-medium text-ds-grey-700"
              >
                {item}
              </Badge>
            ))}
        ...
        <div className="space-y-2">
          <p className="text-sm font-semibold text-ds-grey-900">산업 규모</p>
          <div className="min-h-10 rounded-md border border-ds-grey-200 bg-ds-grey-50 px-4 py-2.5 text-sm leading-relaxed text-ds-grey-900">
            {analysis.marketSize}
          </div>
        </div>

        <div className="space-y-2">
          <p className="text-sm font-semibold text-ds-grey-900">산업 트렌드 요약</p>
          <LineRows items={analysis.trend} />
        </div>

        <div className="space-y-2">
          <p className="text-sm font-semibold text-ds-grey-900">규제 리스크</p>
          <LineRows items={analysis.regulation} />
        </div>

        <div className="space-y-2">
          <p className="text-sm font-semibold text-ds-grey-900">경쟁 구도</p>
        ...
        <div className="space-y-2">
          <p className="text-sm font-semibold text-ds-grey-900">채용 트렌드</p>
          <LineRows items={analysis.hiring} />
        </div>

        <div className="space-y-2">
          <p className="text-sm font-semibold text-ds-grey-900">투자 방향</p>
