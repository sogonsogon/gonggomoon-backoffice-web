        ...
        <div className="flex gap-5 flex-1">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 flex flex-col gap-1.5">
                  ...
                  <Select defaultValue="none">
                    <SelectTrigger className="h-10 border-ds-grey-200 bg-white text-ds-grey-500">
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="samsungsds">삼성SDS</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
          ...
          <div className="w-80 shrink-0 flex flex-col gap-3">
            ...
            <div className="bg-white rounded-[10px] border border-ds-grey-200 p-6 flex flex-col gap-4">
              <Button onClick={() => router.back()} className="h-10 w-full">
                AI 분석 시작
              </Button>
              <Button
                asChild
              ...
              >
                <Link href="/recruitment?tab=public">취소</Link>
              </Button>
            </div>
